...
using Camunda_Lesson2_Example1.Handlers;
...
namespace Camunda_Lesson2_Example1
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddCamundaWorker("CoockingReceiptsWorker")
                .AddHandler<GetCookingReceiptsHandler>() // указываем Handler для обработки запроса
                .AddHandler<TeaHandler>()
