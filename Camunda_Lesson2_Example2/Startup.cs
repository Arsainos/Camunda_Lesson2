...
using Camunda_Lesson2_Example2.Handlers;
...
namespace Camunda_Lesson2_Example2
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddCamundaWorker("TimTomWorker", 2)
                .AddHandler<AskTImHandler>() // указываем Handler для обработки запроса
                .AddHandler<AskTomHandler>()
