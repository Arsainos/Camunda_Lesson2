...
using Camunda_Lesson2_Example5.Handlers;
...
namespace Camunda_Lesson2_Example5
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddCamundaWorker("DriveCarWorker")
                .AddHandler<CarDriveHandler>() // указываем Handler для обработки запроса
